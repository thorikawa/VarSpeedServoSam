...
VarSpeedServoSam::VarSpeedServoSam()
{
...
uint8_t VarSpeedServoSam::attach(int pin)
{
  return this->attach(pin, MIN_PULSE_WIDTH, MAX_PULSE_WIDTH);
}

uint8_t VarSpeedServoSam::attach(int pin, int min, int max)
{
...
void VarSpeedServoSam::write(int value)
{
...
void VarSpeedServoSam::writeMicroseconds(int value)
{
...
*/
void VarSpeedServoSam::write(int value, uint8_t speed) {
...
void VarSpeedServoSam::write(int value, uint8_t speed, bool wait) {
  write(value, speed);
...
void VarSpeedServoSam::stop() {
  write(read());
}

void VarSpeedServoSam::slowmove(int value, uint8_t speed) {
...
int VarSpeedServoSam::read() // return the value as degrees
{
  return map(readMicroseconds()+1, SERVO_MIN(), SERVO_MAX(), 0, 180);
}

int VarSpeedServoSam::readMicroseconds()
{
...
bool VarSpeedServoSam::attached()
{
  return servos[this->servoIndex].Pin.isActive;
}

uint8_t VarSpeedServoSam::sequencePlay(servoSequencePoint sequenceIn[], uint8_t numPositions, bool loop, uint8_t startPos) {
...
uint8_t VarSpeedServoSam::sequencePlay(servoSequencePoint sequenceIn[], uint8_t numPositions) {
  return sequencePlay(sequenceIn, numPositions, true, 0);
}

void VarSpeedServoSam::sequenceStop() {
  write(read());
  this->curSeqPosition = CURRENT_SEQUENCE_STOP;
}
