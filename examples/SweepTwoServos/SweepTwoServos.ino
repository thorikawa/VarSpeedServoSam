/*
  ...
  Adapted by Takahiro Horikawa <horikawa.takahiro@gmail.com> for the VarSpeedServoSam library (Sep 2015)
...
VarSpeedServoSam myservo1;  // create servo object to control a servo 
                         // a maximum of eight servo objects can be created 
VarSpeedServoSam myservo2;
